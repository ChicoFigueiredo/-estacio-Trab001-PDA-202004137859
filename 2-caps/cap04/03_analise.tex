...
\begin{figure}[h!]
    ...
    \begin{minipage}[b]{0.45\linewidth}
        \includegraphics[width=0.90\linewidth]{fig/Zabetta-13-anos-primeiro-video}
    \end{minipage}%
    \quad

    \begin{minipage}[b]{0.45\linewidth}
        \includegraphics[width=0.90\linewidth]{fig/Zabetta-18-anos-facul}
    \end{minipage}%
...
Sempre foi uma menina brincalhona, em vários momentos demonstr
