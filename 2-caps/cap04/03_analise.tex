...
\begin{figure}[h!]
    ...
    \begin{minipage}[b]{0.47\linewidth}
        \includegraphics[width=0.95\linewidth]{fig/Zabetta-13-anos-primeiro-video}
    \end{minipage}%
    \quad

    \begin{minipage}[b]{0.47\linewidth}
        \includegraphics[width=0.95\linewidth]{fig/Zabetta-18-anos-facul}
    \end{minipage}%
...
Sempre foi uma menina brincalhona,
